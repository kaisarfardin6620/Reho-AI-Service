...
@router.get("/optimize-expenses", response_model=OptimizationResponse)
...
@router.get("/optimize-budget", response_model=OptimizationResponse)
...
@router.get("/optimize-debt", response_model=OptimizationResponse)
